...
export const AGENDA: AgendaRow[] = [
  ...
  { id: "talk-1", t: "11:00", end: "11:30", kind: "talk", title: "Talk Slot #1", desc: "30 minutes to go deep on something you love." },
  { t: "11:30", end: "11:45", kind: "break", title: "Morning Break", desc: "A quick 15 — stretch your legs and refill the mug." },
  { id: "talk-2", t: "11:45", end: "12:15", kind: "talk", title: "Talk Slot #2", desc: "30 minutes — your stage." },
  { id: "lightning-1", t: "12:15", end: "12:25", kind: "lightning", title: "Lightning Slot #1", desc: "A 10-minute spark before we break for lunch." },
  ...
  { id: "talk-4", t: "14:40", end: "15:10", kind: "talk", title: "Talk Slot #4", desc: "Our final long-form slot of the day." },
  { id: "lightning-3", t: "15:10", end: "15:20", kind: "lightning", title: "Lightning Slot #3", desc: "Another quick hit." },
  { id: "lightning-4", t: "15:20", end: "15:30", kind: "lightning", title: "Lightning Slot #4", desc: "Last spark before the break." },
...
export const SLOT_BY_ID: Record<string, AgendaRow & { id: string }> = Object.fromEntries(
  OPEN_AGENDA_SLOTS.map((row) => [row.id, row]),
);
